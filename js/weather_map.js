...
let append = (data) => {
    ...
    for (let i = 0; i < data.length; i += 8) {
        ...
        html += `
               ...
               <h6 class="card-header text-center mb-2" style="font-size: small">
                ${dt_txt.substring(5, 7)}.${dt_txt.substring(8, 10)}.${dt_txt.substring(0, 4)}
               </h6>
  <img src='http://openweathermap.org/img/w/${icon}.png' class="img-thumbnail d-block border-0" style='width: 100px; height: 100px; margin-left: 0' alt="...">
...
function geoLocation() {
    const successCallback = (position) => {
        ...
        console.log(ajaxCall(currentLocation));
    };
